...
**BioPortal:** [CXSO](https://bioportal.bioontology.org/ontologies/CXSO) — the ontology's canonical name is **CSO**; it is registered as CXSO on BioPortal only because the acronym CSO was unavailable there.
